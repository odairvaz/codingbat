...
public class Exer01 {
	 ...
	 * at start and running up to but not including end, so for example start=1 and end=5 gives the 
	 * series 1, 2, 3, 4. Return a new String[] array containing the string form of these numbers, 
